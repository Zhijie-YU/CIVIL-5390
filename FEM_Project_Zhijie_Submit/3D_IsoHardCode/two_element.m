...
% This program is initially based on linear combined isotropic/kinematic
% hardening model, we use beta to combine them.
...
NLFEA(ITRA, TOL, ATOL, NTOL, TIMS, NOUT, PROP, EXTFORCE, SDISPT, XYZ, LE);
fclose(NOUT);